...
class TestCoal(unittest.TestCase):
    """
    def setUp(self):
        self.wl = coal.WhisperLogger(brokers=['127.0.0.1'],
    ...
    def test_handle_event_with_valid_event(self):
        ...
        self.assertEqual(self.wl.offsets,
            {'NavigationTiming': {1520974380: 1}, 'SaveTiming': {}})
        self.assertEqual(self.wl.events,
            {'NavigationTiming': {1520974380: {'firstPaint': [1]}}, 'SaveTiming': {}})
